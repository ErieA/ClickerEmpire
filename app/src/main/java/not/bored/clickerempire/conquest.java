...
public class conquest extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (army.checkUpgrade("HORSEBACKRIDING")) {
            ...
            addCavalry10.setVisibility(View.GONE);
            substractCavalry10.setVisibility(View.GONE);
            addCavalry100.setVisibility(View.GONE);
            substractCavalry100.setVisibility(View.GONE);
            addCavalry1000.setVisibility(View.GONE);
            substractCavalry1000.setVisibility(View.GONE);
    ...
    public void invade(double enemy, final String civType, final int plunder) {
        ...
        int kill = (int) Math.ceil(enemy * army.EnemyEfficiency());
        if (army.checkUpgrade("HORSEBACKRIDING")) {
        ...
        if (enemy <= 0) {
            try {
                ...
                invading.setText("Invasion Successful!");
                army.invadeAchievementmaker();
                String civTypeA = (civType.replace(" ", "_")).toUpperCase();
