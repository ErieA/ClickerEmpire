...
public class GameSave extends SQLiteOpenHelper implements Serializable {
    ...
    public Map<String, String> saveAchievements() {
        ...
        while (data.moveToNext()) {
            ...
            buffer.append(",");
            buffer.append(data.getString(96));
            buffer.append(",");
            buffer.append(data.getString(97));
            buffer.append(",");
            buffer.append(data.getString(98));
            buffer.append(",");
            buffer.append(data.getString(99));
            buffer.append(",");
            buffer.append(data.getString(100));
            buffer.append(",");
            buffer.append(data.getString(101));
            buffer.append(",");
            buffer.append(data.getString(102));
            buffer.append(",");
            buffer.append(data.getString(103));
            buffer.append(",");
            buffer.append(data.getString(104));
            buffer.append(",");
            buffer.append(data.getString(105));
            buffer.append(",");
            buffer.append(data.getString(106));
            buffer.append(",");
            buffer.append(data.getString(107));
            buffer.append(",");
            buffer.append(data.getString(108));
            buffer.append(",");
            buffer.append(data.getString(109));
            buffer.append(",");
            buffer.append(data.getString(110));
            buffer.append(",");
            buffer.append(data.getString(111));
            buffer.append(",");
            buffer.append(data.getString(112));
            buffer.append(",");
            buffer.append(data.getString(113));
            buffer.append(",");
            buffer.append(data.getString(114));
            buffer.append(",");
            buffer.append(data.getString(115));
            buffer.append(",");
            buffer.append(data.getString(116));
            buffer.append(",");
            buffer.append(data.getString(117));
        }
        data.close();
        Map<String, String> map = new HashMap<String, String>();
        String save[] = buffer.toString().split(",");
        ...
        map.put(DEFEAT_ONE, save[50]);
        map.put(DEFEAT_ONE + "_V", save[51]);
        map.put(DEFEAT_TWO, save[52]);
        map.put(DEFEAT_TWO + "_V", save[53]);
        map.put(DEFEAT_THREE, save[54]);
        map.put(DEFEAT_THREE + "_V", save[55]);
        map.put(DEFEAT_FOUR, save[56]);
        map.put(DEFEAT_FOUR + "_V", save[57]);
        map.put(DEFEAT_FIVE, save[58]);
        map.put(DEFEAT_FIVE + "_V", save[59]);
        map.put(DEFEAT_SIX, save[60]);
        map.put(DEFEAT_SIX + "_V", save[61]);
        map.put(DEFEAT_SEVEN, save[62]);
        map.put(DEFEAT_SEVEN + "_V", save[63]);
        map.put(DEFEAT_EIGHT, save[64]);
        map.put(DEFEAT_EIGHT + "_V", save[65]);
        map.put(DEFEAT_NINE, save[66]);
        map.put(DEFEAT_NINE + "_V", save[67]);
        map.put(DEFEAT_TEN, save[68]);
        map.put(DEFEAT_TEN + "_V", save[69]);
        map.put(INVASIONCOUNTER, save[70]);
        map.put(DEFEATCOUNTER, save[71]);
        map.put(CONQUEROR_THORP, save[72]);
        map.put(CONQUEROR_THORP_COUNTER, save[73]);
        map.put(CONQUEROR_THORP + "_V", save[74]);
        map.put(CONQUEROR_HAMLET, save[75]);
        map.put(CONQUEROR_HAMLET_COUNTER, save[76]);
        map.put(CONQUEROR_HAMLET + "_V", save[77]);
        map.put(CONQUEROR_VILLAGE, save[78]);
        map.put(CONQUEROR_VILLAGE_COUNTER, save[79]);
        map.put(CONQUEROR_VILLAGE + "_V", save[80]);
        map.put(CONQUEROR_SMALL_TOWN, save[81]);
        map.put(CONQUEROR_SMALL_TOWN_COUNTER, save[82]);
        map.put(CONQUEROR_SMALL_TOWN + "_V", save[83]);
        map.put(CONQUEROR_LARGE_TOWN, save[84]);
        map.put(CONQUEROR_LARGE_TOWN_COUNTER, save[85]);
        map.put(CONQUEROR_LARGE_TOWN + "_V", save[86]);
        map.put(CONQUEROR_SMALL_CITY, save[87]);
        map.put(CONQUEROR_SMALL_CITY_COUNTER, save[88]);
        map.put(CONQUEROR_SMALL_CITY + "_V", save[89]);
        map.put(CONQUEROR_LARGE_CITY, save[90]);
        map.put(CONQUEROR_LARGE_CITY_COUNTER, save[91]);
        map.put(CONQUEROR_LARGE_CITY + "_V", save[92]);
        map.put(CONQUEROR_METROPOLIS, save[93]);
        map.put(CONQUEROR_METROPOLIS_COUNTER, save[94]);
        map.put(CONQUEROR_METROPOLIS + "_V", save[95]);
        map.put(CONQUEROR_SMALL_NATION, save[96]);
        map.put(CONQUEROR_SMALL_NATION_COUNTER, save[97]);
        map.put(CONQUEROR_SMALL_NATION + "_V", save[98]);
        map.put(CONQUEROR_NATION, save[99]);
        map.put(CONQUEROR_NATION_COUNTER, save[100]);
        map.put(CONQUEROR_NATION + "_V", save[101]);
        map.put(CONQUEROR_LARGE_NATION, save[102]);
        map.put(CONQUEROR_LARGE_NATION_COUNTER, save[103]);
        map.put(CONQUEROR_LARGE_NATION + "_V", save[104]);
        map.put(CONQUEROR_EMPIRE, save[105]);
        map.put(CONQUEROR_EMPIRE_COUNTER, save[106]);
        map.put(CONQUEROR_EMPIRE + "_V", save[107]);
        map.put(CONQUEROR_CONTINENTAL_EMPIRE, save[108]);
        map.put(CONQUEROR_CONTINENTAL_EMPIRE_COUNTER, save[109]);
        map.put(CONQUEROR_CONTINENTAL_EMPIRE + "_V", save[110]);
        map.put(CONQUEROR_WORLD_CONFEDERATION, save[111]);
        map.put(CONQUEROR_WORLD_CONFEDERATION_COUNTER, save[112]);
        map.put(CONQUEROR_WORLD_CONFEDERATION + "_V", save[113]);
        map.put(CONQUEROR_UNITED_WORLD, save[114]);
        map.put(CONQUEROR_UNITED_WORLD_COUNTER, save[115]);
        map.put(CONQUEROR_UNITED_WORLD + "_V", save[116]);
